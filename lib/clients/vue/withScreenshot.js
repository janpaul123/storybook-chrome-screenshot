...
var withScreenshot = function (options) {
    ...
    var _a = screenshot_options_1.mergeScreenshotOptions(options), delay = _a.delay, viewport = _a.viewport, knobs = _a.knobs, namespace = _a.namespace;
    var channel = addons_1.default.getChannel();
    return function (getStory, ctx) {
        var withContext = function (context) {
            var component = getStory(context);
