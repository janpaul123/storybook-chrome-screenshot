...
program
    ...
    .option('--puppeteer-launch-config [json]', 'JSON string of launch config for Puppeteer.', utils_1.parser.identity, '{"args":["--no-sandbox","--disable-setuid-sandbox"]}')
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                app = new _1.App(options, store, terminal, new _1.Server(options, terminal, child_process_1.spawn), function (id) { return new _1.Browser(id, store, options); });
                _a.label = 1;
            case 1:
                _a.trys.push([1, 7, , 8]);
