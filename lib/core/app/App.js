...
var App = /** @class */ (function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                this.server.start(),
                                Promise.all(this.browsers.map(function (b) { return b.launch(); })),
                            ])];
                    case 1:
                        _b.sent();
                        _a = this;
                        return [4 /*yield*/, Promise.all(this.browsers.map(function (b) { return b.createPage(_this.server.getURL(), function (type, text) {
    ...
    App.prototype.prepare = function () {
        ...
        return Promise.all(this.pages.map(function (p) { return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var e_1;
        ...
        }); }); })).then(function (storiesList) { return _this.store.set(storiesList.reduce(function (acc, cur) { return acc.concat(cur); }, [])); });
    };
