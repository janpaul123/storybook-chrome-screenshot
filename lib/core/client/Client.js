...
var Client = /** @class */ (function () {
    ...
    Client.prototype.prepare = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, clientId, clientsCount, stories;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.gateway.getMetadata()];
                    case 1:
                        _a = _b.sent(), clientId = _a.clientId, clientsCount = _a.clientsCount;
                        return [4 /*yield*/, this.searchTargetStories(clientId, clientsCount)];
                    case 2:
                        stories = _b.sent();
    ...
    Client.prototype.searchTargetStories = function (clientIndex, clientsCount) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.channel.once('setStories', function (_a) {
                ...
                // sequential promises
                list.reduce(function (acc, cur, i) { return acc
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.searchScreenshotWrappersByStory(cur.kind, cur.story)];
                            case 1:
                                res = _a.sent();
